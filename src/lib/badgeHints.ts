...
const BADGE_TEASERS: Record<string, string> = {
  ...
  'lemon-pepper-legend': "This one's about what you order, not what you write in the review.",
  'crispy-devotee': "It's not about what you order — it's about what you write.",
  'ranch-defender': "You don't need to defend anything in writing — just order it.",
  'bone-in-purist': "It's not about what you order — it's about how you write about it.",
  'blue-cheese-believer': "It's not about what you order — it's about how you write about it.",
  'heat-survivor': "Order it, don't just talk about it — something dangerously spicy. Ghost pepper, reaper, habanero... you get the idea.",
  ...
  'jumbo-fan': "It's about the size you pick at checkout, not your prose.",

  'canadiana-confederation': 'You know the year. Turn it into a rating.',
  'canadiana-canada-day': 'You know the date. Turn it into a rating.',
  'canadiana-skateway': 'You know the length, in kilometres. That\'s your rating.',
  'canadiana-great-one': 'You know the number on the jersey. That\'s your rating.',
  'canadiana-loonie': "You know exactly what it's worth. That's your rating.",
  'canadiana-toonie': "Same idea as the coin before it — just worth double.",
  'canadiana-poutine': "You don't need to order it — just mention it in your review.",
  'canadiana-extra-u': "There's more than one word that works, as long as it's spelled the way we spell it up here, not the way Americans do.",
  'canadiana-sorry': 'Canadians say this more than anyone else on Earth — usually for no reason at all.',
  'canadiana-tapped': "There's a very Canadian ritual that happens every spring, when the sap starts running.",
  'canadiana-rink-rat': 'There\'s a sport (and a team) this city loses its mind over, every single winter.',
  'canadiana-timmies': "Mention it in a review — you don't need to actually stop there.",
  'canadiana-honey-garlic': "You don't need to write an essay about it — just order it.",
}
