...
<div
	class="w-full sm:w-72 border-r border-gray-200 dark:border-gray-700 flex flex-col
            h-full sm:h-auto overflow-hidden"
>
	<!-- Header with count and filter -->
	<div
		class="p-4 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-900"
	>
		...
		{#if displayedReviews.length === 0}
			...
			>
				...
				<p class="text-sm text-gray-400">
					{$searchQuery ? 'Try a different search term' : 'Add your first review!'}
				</p>
			</div>
		{:else}
