<script lang="ts">
	...
	function getRatingDescription(category: keyof RatingDescriptions, value: number): string {
		...
		const scores = Object.keys(descriptions)
			.map(Number)
			.sort((a, b) => a - b);
		...
		<div class="space-y-4">
			...
			<div>
				...
				<div class="slider-container">
					...
					<input type="range" min="1" max="10" bind:value={aroma} class="w-full" />
				</div>
		...
		<div class="space-y-4">
			<div>
				...
				<div class="slider-container">
					...
					<input type="range" min="1" max="10" bind:value={sauceQuantity} class="w-full" />
				</div>
				<div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
					<span>Poor</span>
					<span>Excellent</span>
			...
			<div>
				...
				<div class="slider-container">
					...
					<input type="range" min="1" max="10" bind:value={sauceConsistency} class="w-full" />
				</div>
				<div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
					<span>Poor</span>
					<span>Excellent</span>
		...
		<div class="space-y-4">
			<div>
				...
				<div class="slider-container">
					...
					<input type="range" min="1" max="10" bind:value={skinConsistency} class="w-full" />
				</div>
				<div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
					<span>Poor</span>
					<span>Excellent</span>
			...
			<div>
				...
				<div class="slider-container">
					...
					<input type="range" min="1" max="5" bind:value={greasiness} class="w-full" />
				</div>
				<div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
		...
		<div class="space-y-4">
			<div>
				...
				<div class="slider-container">
					<span class="slider-value"
						>{!blueCheeseNA ? formatSliderValue(blueCheeseQuality) : 'N/A'}</span
					>
					<input
						type="range"
						min="1"
			...
			<div>
				...
				<div class="slider-container">
					...
					<input type="range" min="1" max="5" bind:value={satisfactionScore} class="w-full" />
				</div>
				<div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
						...
						<div class="mt-2 text-sm">
							...
							<div class="mt-1 text-gray-600 dark:text-gray-400">
								{getRatingDescription(
									'recommendationScore',
									Math.round(recommendationScore * 2) / 2
								)}
							</div>
						</div>
					{/if}
					{#if recommendationScore < 0 || recommendationScore > 10}
						<div class="mt-1 text-sm text-red-500">Please enter a score between 0 and 10</div>
					{/if}
				</div>
				<div class="flex flex-col space-y-2 mt-3">
					<div class="text-xs text-gray-600 dark:text-gray-400">Score Guide:</div>
