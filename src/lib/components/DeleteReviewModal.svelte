...
<div class="modal">
	...
	<div class="modal-content max-w-md">
		...
		{#if step === 'confirm'}
			<div class="mb-6">
				<p class="text-gray-700 dark:text-gray-300 mb-4">
					Are you sure you want to permanently delete this review for <strong
						>{restaurantName}</strong
					>?
				</p>
				<div
				...
				>
					<p class="text-yellow-800 dark:text-yellow-200 text-sm">
						⚠️ <strong>Warning:</strong> This action cannot be undone. The review and all associated
		...
		{:else}
			...
			<div class="flex justify-end space-x-3">
				<button class="btn-secondary" on:click={onClose} disabled={isDeleting}> Cancel </button>
				<button
